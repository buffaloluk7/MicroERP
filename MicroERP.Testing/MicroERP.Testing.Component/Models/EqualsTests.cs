...
namespace MicroERP.Testing.Component.Models
{
    ...
    public class EqualsTests
    {
        ...
        public void Test_PersonEquatable()
        {
            ...
            var p3 = new PersonModel(9, "Straße 1", "Straße 2", "Straße 3", "Herr", "First", "Last", "", new DateTime(1993, 6, 1));
        ...
        {
            var i1 = new InvoiceModel(1, new DateTime(2014, 1, 1), new DateTime(2014, 1, 10), "Comment", "Message", new PersonModel(), null);
            var i2Isi1 = new InvoiceModel(1, new DateTime(2014, 1, 1), new DateTime(2014, 1, 10), "Comment", "Message", new PersonModel(), null);
            var i3 = new InvoiceModel(2, new DateTime(2010, 10, 10), new DateTime(2011, 10, 10), "Comment #2", "Message #2", new CompanyModel(), null);
